package fr.xebia.unittestwithdagger.internal;
...
import fr.xebia.unittestwithdagger.BuildConfig;

/**
 * https://github.com/blacroix/droidcon_android_tests/blob/master/app/src/test/java/fr/talk/androidtests/CustomRobolectricTestRunner.java
 */
public class CustomRobolectricTestRunner extends RobolectricTestRunner {

    public static final String PATH_ASSET = "../../../assets/" + BuildConfig.BUILD_TYPE;
    public static final String PATH_RESOURCE = "../../../res/merged/" + BuildConfig.BUILD_TYPE;
    public static final String PATH_MANIFEST = "build/intermediates/manifests/full/" + BuildConfig.BUILD_TYPE + "/AndroidManifest.xml";
